...
var link = svg.selectAll(".link")
  ...
  .enter().append("line")
  .attr("class", "link")
  .style("stroke-width", function(d) {return d.weight;}); // LINK-WIDTH
...
node.append("circle")
  ...
  .style("fill", function(d) {return color(d.node_color);})			// NODE-COLOR
...
node.append("text")
  .attr("dx", 10)
  .attr("dy", ".35em")
  .text(function(d) {return d.node_label}) // NODE-TEXT
//  .style("stroke", "gray");
...
function restart() {
  ...
  link.style("stroke-width", function(d) {return d.weight;}); // WIDTH OF THE LINKS AFTER BREAKING WITH SLIDER
