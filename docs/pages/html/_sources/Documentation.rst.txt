...
No installation required for when using the online web-interface. Note that your data will always stay on the client (aka your pc!).
...
.. note::
	Bibtex can be found at the right side at the `github page <https://github.com/erdogant/hnet/>`_.
