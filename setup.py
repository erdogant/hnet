...
setuptools.setup(
     install_requires=['d3heatmap','pypickle','classeval','wget','d3graph','matplotlib','numpy','pandas','statsmodels','networkx','community','python-louvain','tqdm','sklearn','ismember','imagesc','df2onehot'],
     python_requires='>=3',
     name='hnet',
     version=new_version,
