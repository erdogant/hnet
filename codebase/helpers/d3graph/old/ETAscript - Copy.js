...
var link = svg.selectAll(".link")
  ...
  .enter().append("line")
  .attr("class", "link")
  .style("stroke-width", function(d) {return d.edge_weight;}); // LINK-WIDTH
...
function restart() {
  ...
  link.style("stroke-width", function(d) {return d.edge_weight;}); // WIDTH OF THE LINKS AFTER BREAKING WITH SLIDER
